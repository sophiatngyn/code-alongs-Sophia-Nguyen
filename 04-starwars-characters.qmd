...
ggplot(starwars, aes(x = height, y = mass, color = gender)) +
    ...
    labs(
        ...
        y = "Mass",
        color = "Gender",
        title = "Body Mass vs. Height of Starwars Characters by Gender"
    )
```
...
Many masculine characters, much fewer feminine characters, and very few characters whose gender is unknown.
